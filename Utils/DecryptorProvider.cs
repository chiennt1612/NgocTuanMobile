...
namespace Decryptor
{
    ...
    public class DecryptorProvider : IDecryptorProvider
    {
        ...
        public DecryptorProvider(ILogger<DecryptorProvider> _logger, IConfiguration _configuration)
        {
            this._logger = _logger;
            this._configuration = _configuration;
            _rijndael = new RijndaelEnhanced(_configuration["Decryptor:passPhrase"], _configuration["Decryptor:initVector"]);
        }
